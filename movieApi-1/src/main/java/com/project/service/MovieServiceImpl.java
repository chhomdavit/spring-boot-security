...
public class MovieServiceImpl implements MovieService{
	...
	public MovieServiceImpl(MovieRepository movieRepository, FileService fileService, @Value("${project.poster}") String path, @Value("${base.url}") String baseUrl) {
		super();
	...
	public MovieDto addMovie(MovieDto movieDto, MultipartFile file) throws IOException {
		...
		// 6.map movie object to dto object and return if
	...
	public MovieDto updateMovie(Integer movieId, MovieDto movieDto, MultipartFile file) throws IOException {
		...
		//1.check if movie object exits with given moviedId
		...
		//6.generate posterUrl for if
		String posterUrl = baseUrl + "/file/" + fileName; 
		
		//7.map to moviedto and retrun it
		MovieDto response = new MovieDto(
				movie.getMovieId(),
				movie.getTitle(),
				movie.getDirector(),
	...
	public MoviePageResponse getAllMoviesWithPagination(Integer pageNumber, Integer pageSize) {
		...
		return new MoviePageResponse(	movieDtos, pageNumber, pageSize, 
				 				        (long) moviePages.getTotalElements(),
